...
{
    if ([phoneF.text stringByReplacingOccurrencesOfString:@" " withString:@""].length == 11){
        [button attAction];
        [NetWorkTool postPaoGuoZhuCeYanZhengMaWithphoneFNumber:[DSE encryptUseDES:[phoneF.text stringByReplacingOccurrencesOfString:@" " withString:@""]] anduseType:@"1" sccess:^(NSDictionary *responseObject) {
...
{
    if ([[verifyCodeF.text stringByReplacingOccurrencesOfString:@" " withString:@""] isEqualToString:ExyanzhengmaStr]){
