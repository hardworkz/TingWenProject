...
- (void)loginBtnAction:(UIButton *)sender{
    NSLog(@"登录");   
    if ([userTF.text stringByReplacingOccurrencesOfString:@" " withString:@""].length == 0){
    ...
    if ([passWTF.text stringByReplacingOccurrencesOfString:@" " withString:@""].length == 0){
