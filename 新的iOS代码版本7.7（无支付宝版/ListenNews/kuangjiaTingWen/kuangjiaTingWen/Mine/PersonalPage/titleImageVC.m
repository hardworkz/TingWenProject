...
@interface titleImageVC ()<UITableViewDataSource,UITableViewDelegate,UIActionSheetDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate>
{
    BOOL             isFullScreen;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0 && indexPath.row == 0)
    {
        ...
        [touxiangImage sd_setImageWithURL:[NSURL URLWithString:userInfoDic[results][@"avatar"]]];
...
- (void)shangchuantouxiangChengGong:(NSNotification *)notification{
    ...
    [touxiangImage sd_setImageWithURL:[NSURL URLWithString:userInfoDict[results][@"avatar"]]];
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info{
    ...
    [manager POST:@"http://ceshi.tingwen.me/index.php/api/interfaceNew/uploadHeadImgNew" parameters:dict constructingBodyWithBlock:^(id<AFMultipartFormData> formData) {
