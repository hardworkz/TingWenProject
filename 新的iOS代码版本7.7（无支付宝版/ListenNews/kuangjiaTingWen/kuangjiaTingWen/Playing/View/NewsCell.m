...
//            detailNews.backgroundColor = [UIColor redColor];
        ...
        [downloadBtn setFrame:CGRectMake(CGRectGetMaxX(dataLab.frame), 81.0 / 667 *IPHONE_H + offsetY + 5, 35.0 / 667 *IPHONE_H, 35.0 / 667 *IPHONE_H)];
        if (IS_IPHONEX){
            [downloadBtn setFrame:CGRectMake(CGRectGetMaxX(dataLab.frame), 81.0 + offsetY + 5, 35.0, 35.0)];
        }
