...
+ (void)isNewDayWithServer_date:(NSString *)dateString
{
    ...
    if (![dateString isEqualToString:serverDate]) {//判断本地缓存时间和服务器返回时间是否一致，不一致则清空新闻播放限制次数
        ...
        //初始化讯飞语音为可使用状态
        if (![[CommonCode readFromUserD:use_ifly_reader] boolValue]) {
...
+(void)asyncNetworkingUrl:(NSString *)url
    ...
    if ([[CommonCode readFromUserD:@"isLogin"] boolValue] == NO && ![url isEqualToString:@"/interfaceNew/loginNew"] && ![url isEqualToString:@"/interfaceNew/oauthLoginNew"] && ![url isEqualToString:@"/interface/sendVcode"] && ![url isEqualToString:@"/interfaceNew/register"] &&![url isEqualToString:@"/interface/forgetPwd"]) {//拦截判断当前是否登录，未登录则清空accessToken
        [param setValue:@"" forKey:@"accessToken"];
    }
    //发送请求
...
//获取进入app的广告界面
+ (void)getIntoAppGuangGaoAccessToken:(NSString *)accessToken
    ...
    RTLog(@"%@",ExdangqianUser);
    [self asyncNetworkingUrl:@"/interface/kaiListNew" andDict:dic success:success failure:failure];
}
...
+ (void)getPaoGuoUserInfoWithUserName:(NSString *)accessToken andPassWord:(NSString *)password sccess:(void (^)(NSDictionary *responseObject))success failure:(void(^)(NSError *error))failure
{
    ...
    dic[@"accessToken"] = accessToken;
    dic[@"password"] = password;
    [self asyncNetworkingUrl:@"/interfaceNew/loginNew" andDict:dic success:success failure:failure];
}
//修改用户信息上传
...
///获取我的订阅列表
+ (void)getPaoGuoSelfWoDeJieMuNewWithaccessToken:(NSString *)accessToken
                               andId:(NSString *)Id
    ...
    dic[@"datatype"] = type;
    dic[@"limit"] = limit;
    [self asyncNetworkingUrl:@"/interface/acanNew1" andDict:dic success:success failure:failure];
}
///添加节目关注
...
+ (void)getPaoGuoGuanZhuLieBiaoWithaccessToken:(NSString *)accessToken andPage:(NSString *)page andLimit:(NSString *)limit sccess:(void (^)(NSDictionary *responseObject))success failure:(void (^)(NSError *error))failure
{
    ...
    dic[@"page"] = page;
    dic[@"limit"] = limit;
    [self asyncNetworkingUrl:@"/interface/attentionListNew" andDict:dic success:success failure:failure];
}
...
+ (void)getMyDynamicsListWithaccessToken:(NSString *)accessToken
    ...
    dic[@"page"] = page;
    dic[@"limit"] = limit;
    [self asyncNetworkingUrl:@"/interfaceYou/myDynamicsNew" andDict:dic success:success failure:failure];
}
...
+ (void)getPaoGuoSelfFenSiLieBiaoWithaccessToken:(NSString *)accessToken andPage:(NSString *)page andLimit:(NSString *)limit sccess:(void (^)(NSDictionary *responseObject))success failure:(void (^)(NSError *error))failure
{
    ...
    dic[@"page"] = page;
    dic[@"limit"] = limit;
    [self asyncNetworkingUrl:@"/interface/fanListNew" andDict:dic success:success failure:failure];
}
...
//    dic[@"ac_id"] = ac_id;
    ...
    dic[@"page"] = page;
    dic[@"limit"] = limit;
    [self asyncNetworkingUrl:@"/interfaceNew/searchActLessonNew"
                     andDict:dic
                     success:success
                     failure:failure];
}
...
+ (void)getPaoGuoJieMuPingLunLieBiaoWithJieMuID:(NSString *)post_id anduid:(NSString *)uid andPage:(NSString *)page andLimit:(NSString *)limit sccess:(void (^)(NSDictionary *responseObject))success failure:(void (^)(NSError *error))failure
{
    ...
    dic[@"page"] = page;
    dic[@"limit"] = limit;
    [self asyncNetworkingUrl:@"/interface/commentListNew" andDict:dic success:success failure:failure];
}
///针对新闻进行评论（可以回复新闻中的评论）
...
+ (void)getPaoGuoShouYeSouSuoLieBiao:(NSString *)str sccess:(void (^)(NSDictionary *responseObject))success failure:(void (^)(NSError *error))failure
{
    NSMutableDictionary *dic = [[NSMutableDictionary alloc]initWithCapacity:1];
    dic[@"accessToken"] = str;
    [self asyncNetworkingUrl:@"/interfaceNew/findIndexNew" andDict:dic success:success failure:failure];
}
...
+ (void)getPaoguoJieMuLieBiaoWithterm_id:(NSString *)term_id
    ...
    dic[@"term_id"] = term_id;
    dic[@"accessToken"] = accessToken;
    [self asyncNetworkingUrl:@"/interfaceNew/findListNew" andDict:dic success:success failure:failure];
}
...
+ (void)getNewSlideListWithaccessToken:(NSString *)accessToken
    ...
    NSMutableDictionary *dic = [[NSMutableDictionary alloc]initWithCapacity:1];
    dic[@"accessToken"] = accessToken;
    [self asyncNetworkingUrl:@"/interfaceNew/adsNew" andDict:dic success:success failure:failure];
}
///获取随机用户信息（推荐好友列表）
...
+ (void)postPaoGuoDiSanFangDengLuJieKouwithname:(NSString *)name
    ...
    [self asyncNetworkingUrl:@"/interfaceNew/oauthLoginNew"
                     andDict:dic
                     success:success
                     failure:failure];
}
...
+ (void)getFeedBackListWithaccessToken:(NSString *)accessToken
    ...
    dic[@"page"] = page;
    dic[@"limit"] = limit;
    [self asyncNetworkingUrl:@"/interfaceYou/feedBackListNew" andDict:dic success:success failure:failure];
}
...
+ (void)uploadImagesWithaccessToken:(NSString *)accessToken
    ...
    dic[@"accessToken"] = accessToken;
    dic[@"images"] = images;
    [self asyncNetworkingUrl:@"/interfaceYou/uploadImagesNew" andDict:dic success:success failure:failure];
...
+ (void)getLinsteningCircleListWithaccessToken:(NSString *)accessToken
    ...
    dic[@"page"] = page;
    dic[@"limit"] = limit;
    [self asyncNetworkingUrl:@"/interfaceYou/friendDynamicsNew" andDict:dic success:success failure:failure];
...
+ (void)uploadMpVoiceWithaccessToken:(NSString *)accessToken
    ...
    [self asyncNetworkingUrl:@"/interfaceYou/uploadMpVoiceNew" andDict:dic success:success failure:failure];
}
...
+ (void)getAddcriticismNumWithaccessToken:(NSString *)accessToken
    ...
    dic[@"limit"] = limit;
    dic[@"date"] = date;
    [self asyncNetworkingUrl:@"/interface/addcriticismNew" andDict:dic success:success failure:failure];
}
...
+ (void)getNewPromptForMeWithaccessToken:(NSString *)accessToken
    ...
    dic[@"page"] = page;
    dic[@"limit"] = limit;
    [self asyncNetworkingUrl:@"/interfaceYou/newPromptForMeNew" andDict:dic success:success failure:failure];
}
...
+ (void)feedbackGetOneWithaccessToken:(NSString *)accessToken
    ...
    dic[@"accessToken"] = accessToken;
    dic[@"feedback_id"] = feedback_id;
    [self asyncNetworkingUrl:@"/interfaceYou/feedbackGetOneNew" andDict:dic success:success failure:failure];
}
...
+ (void)getPostDetailWithaccessToken:(NSString *)accessToken
    ...
    dic[@"accessToken"] = accessToken;
    dic[@"post_id"] = post_id;
    [self asyncNetworkingUrl:@"/interfaceNew/postDetailNew1" andDict:dic success:success failure:failure];
}
...
+ (void)getMySubscribeWithaccessToken:(NSString *)accessToken
    ...
    dic[@"accessToken"] = accessToken;
    dic[@"limit"] = limit;
    [self asyncNetworkingUrl:@"/interfaceNew/subscribeNew" andDict:dic success:success failure:failure];
}
...
+ (void)getMyuserinfoWithaccessToken:(NSString *)accessToken
    ...
    dic[@"accessToken"] = accessToken;
    dic[@"user_id"] = user_id;
    [self asyncNetworkingUrl:@"/interfaceNew/userinfoNew" andDict:dic success:success failure:failure];
}
...
+ (void)listBuyWithaccessToken:(NSString *)accessToken
    ...
    dic[@"page"] = page;
    dic[@"limit"] = limit;
    [self asyncNetworkingUrl:@"/interfaceNew/listBuyNew" andDict:dic success:success failure:failure];
}
...
+ (void)getColumnListWithaccessToken:(NSString *)accessToken
    ...
    dic[@"adNum"] = page;
    dic[@"limit"] = limit;
    [self asyncNetworkingUrl:@"/interfaceNew/specialColumn" andDict:dic success:success failure:failure];
}
...
+ (void)getInformationNewListWithaccessToken:(NSString *)accessToken
    ...
    dic[@"limit"] = limit;
    dic[@"page"] = page;
    [self asyncNetworkingUrl:@"/interfaceNew/newsFlash" andDict:dic success:success failure:failure];
}
...
+ (void)getClassroomListWithaccessToken:(NSString *)accessToken
    ...
    dic[@"page"] = page;
    dic[@"limit"] = limit;
    [self asyncNetworkingUrl:@"/interfaceNew/classroomNew" andDict:dic success:success failure:failure];
}
...
+ (void)getAuditionListWithaccessToken:(NSString *)accessToken
    ...
    dic[@"accessToken"] = accessToken;
    dic[@"act_id"] = act_id;
    [self asyncNetworkingUrl:@"/interfaceNew/auditionNew1" andDict:dic success:success failure:failure];
...
+ (void)get_membersDataWithaccessToken:(NSString *)accessToken
    ...
    NSMutableDictionary *dic = [[NSMutableDictionary alloc]initWithCapacity:1];
    dic[@"accessToken"] = accessToken;
    [self asyncNetworkingUrl:@"/interfaceNew/memberNew" andDict:dic success:success failure:failure];
}
//支付宝购买统一接口
...
//保存帮你读url
+ (void)readSaveWithAccessToken:(NSString *)accessToken
                          ID:(NSString *)ID
                          title:(NSString *)title
                    article_url:(NSString *)article_url
    ...
    dic[@"id"] = ID;
    dic[@"title"] = title;
    dic[@"article_url"] = article_url;
    dic[@"img_url"] = img_url;
    dic[@"createtime"] = createtime;
    [self asyncNetworkingUrl:@"/interfaceNew/readSave" andDict:dic success:success failure:failure];
}
//删除帮你读url
+ (void)readDeleteWithAccessToken:(NSString *)accessToken
                          Id :(NSString *)Id
                         sccess:(void (^)(NSDictionary *responseObject))success
                        failure:(void(^)(NSError *error))failure{
    NSMutableDictionary *dic = [[NSMutableDictionary alloc]initWithCapacity:1];
    dic[@"accessToken"] = accessToken;
    dic[@"id"] = Id;
    [self asyncNetworkingUrl:@"/interfaceNew/readDel" andDict:dic success:success failure:failure];
}
//获取帮你读列表数据
+ (void)getReadWithAccessToken:(NSString *)accessToken
                           sccess:(void (^)(NSDictionary *responseObject))success
                          failure:(void(^)(NSError *error))failure{
    NSMutableDictionary *dic = [[NSMutableDictionary alloc]initWithCapacity:1];
    dic[@"accessToken"] = accessToken;
    [self asyncNetworkingUrl:@"/interfaceNew/read" andDict:dic success:success failure:failure];
}
//获取帮你读url标题
+ (void)getUrlTitleWithURL:(NSString *)URL
                        sccess:(void (^)(NSDictionary *responseObject))success
                       failure:(void(^)(NSError *error))failure{
    NSMutableDictionary *dic = [[NSMutableDictionary alloc]initWithCapacity:1];
    dic[@"url"] = URL;
    [self asyncNetworkingUrl:@"/interfaceNew/getTitle" andDict:dic success:success failure:failure];
}
@end
