...
- (CALayer *)pulsingLayer:(CGRect)rect animation:(CAAnimationGroup *)animationGroup {
    ...
    if (_animationType == AnimationTypeWithBackground) {
        pulsingLayer.backgroundColor = ColorWithAlpha(0, 159, 240, 0.5).CGColor;
        pulsingLayer.borderWidth = 0.5;
    } else {
        pulsingLayer.borderWidth = 1.f;
    }
    
    pulsingLayer.borderColor = ColorWithAlpha(0, 159, 240, 0.5).CGColor;
...
- (CAKeyframeAnimation *)backgroundColorAnimation {
    ...
    backgroundColorAnimation.values = @[(__bridge id)ColorWithAlpha(0, 159, 240, 0.4).CGColor,
                                        (__bridge id)ColorWithAlpha(0, 159, 240, 0.4).CGColor,
                                        (__bridge id)ColorWithAlpha(0, 169, 230, 0.4).CGColor,
                                        (__bridge id)ColorWithAlpha(0, 169, 230, 0).CGColor];
